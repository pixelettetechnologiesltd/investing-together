    ...
    <div>
      ...
      <section className="bg-color-faroz">
        <Container>
          <Row>
            <Col md={6}>
              <h2 className="left-black-head-48">
                Get a free guide on investing <br></br>with investing together
              </h2>
              <p className="desc-froz-bg padding-right-130">
            ...
            <Col md={4}>
              <div className="black-bg">
                <Image src={images.logohd} width="18%" />
                <p className="feroze-left-head">
                  A guide to <br></br>investing together
                </p>
